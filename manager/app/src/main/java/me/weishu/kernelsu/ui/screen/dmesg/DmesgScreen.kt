...
fun DmesgScreen() {
    ...
    when (LocalUiMode.current) {
        UiMode.Miuix -> DmesgScreenMiuix(uiState, viewModel::setSearchQuery, viewModel::loadDmesg, viewModel::toggleLiveMode, context, navigator)
        UiMode.Material -> DmesgScreenMaterial(uiState, viewModel::setSearchQuery, viewModel::loadDmesg, viewModel::toggleLiveMode, context, navigator)
    }
}
