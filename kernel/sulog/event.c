...
struct ksu_sulog_pending_event *ksu_sulog_capture_root_execve(const char *filename,
                                                              struct user_arg_ptr *argv_user, gfp_t gfp)
{
    return ksu_sulog_capture(KSU_SULOG_EVENT_ROOT_EXECVE, filename, argv_user, gfp);
}
