...
const val DMESG_LINE_LIMIT = 50000
...
fun filterDmesgLines(
    lines: List<String>,
    query: String,
    order: DmesgOrder = DmesgOrder.ASCENDING
): List<String> {
    val base = if (order == DmesgOrder.DESCENDING) lines.asReversed() else lines
